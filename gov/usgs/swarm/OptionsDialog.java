...
/**
 * 
 * $Log: not supported by cvs2svn $ Revision 1.6 2006/07/22 20:28:57 cervelli Time zone changes.
 *
 * Revision 1.5 2006/06/05 18:06:49 dcervelli Major 1.3 changes.
 *
 * @author Dan Cervelli
...
public class OptionsDialog extends SwarmDialog {
    ...
    protected void createUI() {
        ...
        FormLayout layout =
                new FormLayout("right:max(30dlu;pref), 3dlu, 40dlu, 3dlu, right:max(40dlu;pref), 3dlu, 40dlu", "");
    ...
    public void setCurrentValues() {
        ...
        if (Swarm.config.useLocalTimeZone) tzLocal.setSelected(true);
        else tzSpecific.setSelected(true);
