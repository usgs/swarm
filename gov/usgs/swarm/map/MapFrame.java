...
public class MapFrame extends SwarmFrame implements Runnable, Kioskable {
	...
	private void createToolbar() {
		...
		Util.mapKeyStrokeToButton(this, "ctrl BACK_SPACE", "mapback1",
				backButton);
		...
		Util.mapKeyStrokeToButton(this, "control C", "clipboard1",
				clipboardButton);
	...
	class CaptureActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			BufferedImage image = new BufferedImage(mapPanel.getWidth()
					- i.left - i.right,
					mapPanel.getHeight() - i.top - i.bottom,
