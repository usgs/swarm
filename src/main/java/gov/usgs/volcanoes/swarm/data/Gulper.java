...
public class Gulper implements Runnable {
   ...
   */
  public Gulper(GulperList gl, String k, SeismicDataSource source, String ch, double t1, double t2,
      int size, int delay) {
   ...
   */
  public Gulper(GulperList gl, String k, GulperListener glnr, SeismicDataSource source, String ch,
      double t1, double t2, int size, int delay) {
