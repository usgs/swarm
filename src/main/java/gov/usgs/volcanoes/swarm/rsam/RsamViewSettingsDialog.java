...
public class RsamViewSettingsDialog extends SwarmModalDialog {
  ...
  /*
   * private ButtonGroup filterGroup; private JCheckBox filterEnabled; private JRadioButton lowPass;
   * private JRadioButton highPass; private JRadioButton bandPass; private JCheckBox zeroPhaseShift;
   * private JTextField corner1; private JTextField corner2; private JSlider order;
   */
  ...
  public void setToCurrent() {
     ...
     * 
     * switch (settings.filter.getType()) { case LOWPASS: lowPass.setSelected(true);
     * corner1.setText("0.0"); corner2.setText(String.format("%.1f", settings.filter.getCorner1()));
     * break; case HIGHPASS: highPass.setSelected(true); corner1.setText(String.format("%.1f",
     * settings.filter.getCorner1())); corner2.setText("0.0"); break; case BANDPASS:
     * bandPass.setSelected(true); corner1.setText(String.format("%.1f",
     * settings.filter.getCorner1())); corner2.setText(String.format("%.1f",
     * settings.filter.getCorner2())); break; default: break; }
  ...
  private void createComponents() {
    ...
    /*
     * filterGroup = new ButtonGroup(); filterEnabled = new JCheckBox("Enabled"); lowPass = new
     * JRadioButton("Low pass"); highPass = new JRadioButton("High pass"); bandPass = new
     * JRadioButton("Band pass"); filterGroup.add(lowPass); filterGroup.add(highPass);
     * filterGroup.add(bandPass); zeroPhaseShift = new JCheckBox("Zero phase shift"); corner1 = new
     * JTextField(7); corner2 = new JTextField(7); order = new JSlider(2, 8, 4);
     * order.setMajorTickSpacing(2); order.setSnapToTicks(true); order.createStandardLabels(2);
  ...
  protected void createUi() {
     ...
     * 
     * builder.append(filterEnabled, 3); builder.append(zeroPhaseShift, 3); builder.nextLine();
     * builder.append(lowPass, 3); builder.add(new JLabel("Min. frequency:"),
     * cc.xy(builder.getColumn(), builder.getRow(), "right, center")); builder.nextColumn(2);
     * builder.append(corner1); builder.nextLine(); builder.append(highPass, 3); builder.add(new
     * JLabel("Max. frequency:"), cc.xy(builder.getColumn(), builder.getRow(), "right, center"));
     * builder.nextColumn(2); builder.append(corner2); builder.nextLine(); builder.append(bandPass,
     * 3); builder.add(new JLabel("Order"), cc.xyw(builder.getColumn(), builder.getRow(), 3,
     * "center, center")); builder.nextLine(); builder.appendRow("center:20dlu");
     * builder.nextColumn(3); builder.append(order, 4); builder.nextLine();
     */
  ...
  public void wasOk() {
    try {
      ...
      /*
       * settings.filterOn = filterEnabled.isSelected(); settings.zeroPhaseShift =
       * zeroPhaseShift.isSelected();
       * 
       * FilterType ft = null; double c1 = 0; double c2 = 0; if (lowPass.isSelected()) { ft =
       * FilterType.LOWPASS; c1 = Double.parseDouble(corner2.getText()); c2 = 0; } else if
       * (highPass.isSelected()) { ft = FilterType.HIGHPASS; c1 =
       * Double.parseDouble(corner1.getText()); c2 = 0; } else if (bandPass.isSelected()) { ft =
       * FilterType.BANDPASS; c1 = Double.parseDouble(corner1.getText()); c2 =
       * Double.parseDouble(corner2.getText()); } settings.filter.set(ft, order.getValue(), 100.0,
       * c1, c2);
       */
