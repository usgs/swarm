...
public class MapFrame extends SwarmFrame implements Runnable, Kioskable, SwarmOptionsListener {
	...
	private void createToolbar() {
		...
		final JButton earthButton = SwarmUtil.createToolBarButton(Icons.earth, "Zoom out to full scale (Home)",
				new ActionListener() {
					public void actionPerformed(final ActionEvent e) {
		...
		final JButton zoomIn = SwarmUtil.createToolBarButton(Icons.zoomplus, "Zoom in (+)", new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				mapPanel.zoom(0.5);
			}
		});
		...
		final JButton zoomOut = SwarmUtil.createToolBarButton(Icons.zoomminus, "Zoom out (-)", new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				mapPanel.zoom(2);
			}
		});
		...
		final JButton backButton = SwarmUtil.createToolBarButton(Icons.geoback, "Last map view (Ctrl-backspace)",
				new ActionListener() {
					public void actionPerformed(final ActionEvent e) {
						mapPanel.mapPop();
					}
	...
	class CaptureActionListener implements ActionListener {
		public void actionPerformed(final ActionEvent e) {
			...
			if (result == JFileChooser.APPROVE_OPTION) {
				...
				if (f.exists()) {
					final int choice = JOptionPane.showConfirmDialog(applicationFrame, "File exists, overwrite?",
